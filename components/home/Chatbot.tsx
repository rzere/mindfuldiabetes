            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <button 
                  ...
                  className="mx-auto mb-5 flex max-w-fit animate-fade-up items-center justify-center space-x-2 overflow-hidden rounded-full bg-blue-100 px-7 py-2 transition-colors hover:bg-blue-200 text-sm font-semibold text-[#1d9bf0]"
                >
